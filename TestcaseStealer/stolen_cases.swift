...
let tests_6502 : [TestCase] = [
    ...
    TestCase(
        "test_lda_zp_x_has_page_wrap_bug",
    ...
    TestCase(
        "test_brk_preserves_decimal_flag_when_it_is_clear",
    ...
    TestCase(
        "test_lda_zp_x_indexed_page_wraps",
        TestState(CpuState(A:0x00, X:0xff, Y:0x00, SP:0xff, PC:0x0000, SR:SR(0x30)),
                  [0x0000:0xb5, 0x0001:0x80, 0x007f:0x42]),
        TestState(CpuState(A:0x42, X:0xff, Y:0x00, SP:0xff, PC:0x0002, SR:SR(0x30)),
                  [0x0000:0xb5, 0x0001:0x80, 0x007f:0x42])
    ...
    TestCase(
        "test_and_indexed_ind_y_has_page_wrap_bug",
    ...
    TestCase(
        "test_brk_preserves_decimal_flag_when_it_is_set",
    ...
    TestCase(
        "test_jmp_jumps_to_address_with_page_wrap_bug",
        TestState(CpuState(A:0x00, X:0x00, Y:0x00, SP:0xff, PC:0x0000, SR:SR(0x30)),
    ...
    TestCase(
        "test_lda_ind_indexed_x_has_page_wrap_bug",
        TestState(CpuState(A:0x00, X:0xff, Y:0x00, SP:0xff, PC:0x0000, SR:SR(0x30)),
    ...
    TestCase(
        "test_sbc_indexed_ind_y_has_page_wrap_bug",
    ...
    TestCase(
        "test_adc_ind_indexed_has_page_wrap_bug",
    ...
    TestCase(
        "test_adc_indexed_ind_y_has_page_wrap_bug",
    ...
    TestCase(
        "test_cmp_indexed_ind_y_has_page_wrap_bug",
        TestState(CpuState(A:0x42, X:0x00, Y:0x02, SP:0xff, PC:0x1000, SR:SR(0x00)),
    ...
    TestCase(
        "test_ora_indexed_ind_y_has_page_wrap_bug",
    ...
    TestCase(
        "test_eor_indexed_ind_y_has_page_wrap_bug",
    ...
    TestCase(
        "test_cmp_ind_x_has_page_wrap_bug",
    ...
    TestCase(
        "test_lda_indexed_ind_y_has_page_wrap_bug",
        TestState(CpuState(A:0x00, X:0x00, Y:0x02, SP:0xff, PC:0x1000, SR:SR(0x30)),
    ...
    TestCase(
        "test_eor_ind_x_has_page_wrap_bug",
